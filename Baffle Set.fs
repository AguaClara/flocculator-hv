...
import(path : "ff0f26334dc9ed5e1dbbc027", version : "05a756fd6fa37cc696720e75");
baffleModule::import(path : "c2f4584cf9d8b1114f7ff5b4", version : "d1560d5dbaff9f98a4c06dd6");
...
export const baffleSetGeometry = function(context is Context, id is Id, design is map) returns map
    {
        for (var i = 1; i <= design.channelN; i += 1) //for every discrete number from 1 to N
        {
            ...
            {
                design.originY = (-design.channelL + 2 * (design.baffleS + design.baffleT)) / meter; //location of origin, ADJUST
