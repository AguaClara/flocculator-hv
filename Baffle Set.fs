...
baffleModule::import(path : "c2f4584cf9d8b1114f7ff5b4", version : "43edc0545a1747a4551044ff");
...
export const baffleSetGeometry = function(context is Context, id is Id, design is map) returns map
    {
        for (var i = 1; i <= design.channelN; i += 1) //for every discrete number from 1 to N
        {
            ...
            {
                design.originY = (-design.channelL + 2 * design.baffleS + 24*design.baffleT) / meter; //location of origin, ADJUST
