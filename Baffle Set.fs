...
baffleModule::import(path : "c2f4584cf9d8b1114f7ff5b4", version : "9e70bb2aab214135348b3c7e");
...
export const baffleSetGeometry = function(context is Context, id is Id, design is map) returns map
    {
        for (var i = 1; i < design.channelN; i += 1) //for every discrete number from 1 to N
        {
            ...
            {
                design.originY = 0;
                design.originV1 = vector(0, 0, 1) * meter;
            ...
            else
            {
                ...
                design.originV1 = vector(1, 0, 0) * meter;
