...
export const bafflePreDesigner = function(design) returns map
    {
        ...
        design.pipe.fittingR = (queryFittingDim(design.pipe.ND, design.ip, "CAP", FittingShape.CAP, ConnectionStyle.SOCKET_CONNECT, "OD")) / 2; //distance from node to outer cap, TBD
