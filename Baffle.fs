FeatureScript 1605;
import(path : "2fa81f50be25609bc956cd5f/4a9479ad28008f203d65f8fd/40a6bde79e4081741060af59", version : "644ba0425bd999973c4a9616");
import(path : "c0af0d6b5703e7a8fb53f53f/105be0fe0a9e98c9639a9789/0f7fbd6e5e57d50d045b4ccd", version : "a9e31f7448787e966d06d2b2");
...
export const bafflePreDesigner = function(design) returns map
    {
        ...
        design.spacer = queryPipeDim(1, design.ip, 26, ["ND", "ID", "OD", "schedule"]); //these all have to be things that are in obtained by the query. HMMM... Maybe I should make a "return everything" option.
