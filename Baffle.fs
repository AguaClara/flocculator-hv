...
export const bafflePreDesigner = function(design) returns map
    {
        ...
        design.pipe.fittingR = (queryFittingDim(design.pipe.ND, design.ip, FittingType.CAP, FittingShape.CAP, ConnectionStyle.SOCKET_CONNECT, ["sOD"])) / 2; //distance from node to outer cap, TBD
