...
export const bafflePreDesigner = function(design) returns map
    {
        ...
        design.spacer.front1D = design.channelL - 2*design.baffleB - design.fitting.socketL - design.fitting.R + design.baffleT;
        design.spacer.botfront2D = design.baffleB*(design.baffleN - 2) + design.washerT - design.fitting.R;
