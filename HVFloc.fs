...
import(path : "2dbacff0d2cf5928d7043f72", version : "d8d6ad5d7d800cd96fc3e83b");
        ...
        children : {
            ...
            baffleSet : {
                ...
                inputs : {
                    ...
                    ip : "$.ip",
                    channelN : "$.channelN",
                    channelT : "$.channelWallT", //not defined in this FS, just reference?? Also, check out the diff between interior and exterior wall thicknesses
                    channelW : "$.channelW",
                    channelL : "$.L",
                    tankH : "", //TBD
                    FB : "$.FB",
