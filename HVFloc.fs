...
import(path : "2dbacff0d2cf5928d7043f72", version : "27d35586b383895a9a216eab");
import(path : "c0af0d6b5703e7a8fb53f53f/21a5c49c2b3a40de5971a41d/2b514867aec34e779649c734", version : "de0e954ad3f716279a6d1143");
...
export const hvFlocPreDesigner = function(design) returns map
    {
        ...
        design.channelN = min([floor(design.W_total / design.channelW_min), ceil(design.W_total / design.baffleChannelW_max)]); //make sure we don't try zero channels
